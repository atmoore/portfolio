    ...
    contactForm.addEventListener('submit', async (e) => {
      ...
      if (isValid) {
        try {
          ...
          // For this example, we'll use Formspree (you'll need to set up an account)
          ...
          successAnnouncement.classList.add('visually-hidden');
          successAnnouncement.textContent = 'Your message has been sent successfully. Thank you!';
